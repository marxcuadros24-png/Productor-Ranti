...
export default function OrderCard({ order }) {
  ...
  return (
    <div className="rounded-2xl border border-stone-100 bg-white p-5 shadow-sm transition-all hover:shadow-md sm:p-6">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl bg-green-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-green-700 hover:shadow-md active:scale-[0.98]"
            >
              Ver detalles
              <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
